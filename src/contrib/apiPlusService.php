...
require_once 'service/apiServiceRequest.php';
  ...
  class ActivitiesServiceResource extends apiServiceResource {
     ...
     * @opt_param integer maxResults The maximum number of activities to include in the response, used for paging. For any response, the actual number returned may be less than the specified maxResults.
  ...
  class CommentsServiceResource extends apiServiceResource {
     ...
     *
     * @opt_param string pageToken The continuation token, used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
     * @opt_param integer maxResults The maximum number of comments to include in the response, used for paging. For any response, the actual number returned may be less than the specified maxResults.
     * @return CommentFeed
     */
  ...
  class PeopleServiceResource extends apiServiceResource {
     ...
     *
     * @opt_param string pageToken The continuation token, used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
     * @opt_param integer maxResults The maximum number of people to include in the response, used for paging. For any response, the actual number returned may be less than the specified maxResults.
     * @return PeopleFeed
     */
...
class PeopleFeed extends apiModel {
  ...
  public function setItems(Person $items) {
    $this->items = $items;
  }
